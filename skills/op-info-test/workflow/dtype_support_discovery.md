...
2. collect dtype candidates from docs
3. verify them with runtime probing
...
1. collect dtype candidates from aclnn and MindSpore docs
2. run the runtime probe
...
1. Collect candidate dtypes from aclnn and MindSpore docs.
