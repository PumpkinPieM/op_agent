...
def _ops():
    ...
    if _CUSTOM_OPS is None:
        ...
        try:
            _CUSTOM_OPS = ms.ops.CustomOpBuilder("custom_ops_npu_fused_infer_attention_score_test", [str(KERNEL_SOURCE)], backend="Ascend").load()
