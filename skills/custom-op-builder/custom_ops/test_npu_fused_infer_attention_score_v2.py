...
def _ops():
    ...
    if _CUSTOM_OPS is None:
        ...
        try:
            _CUSTOM_OPS = ms.ops.CustomOpBuilder("custom_ops_npu_fused_infer_attention_score_v2_test", [str(KERNEL_SOURCE)], backend="Ascend").load()
...
def test_npu_fused_infer_attention_score_v2_matches_torch_npu():
    ...
    try:
        expected = torch_npu.npu_fused_infer_attention_score_v2(_torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), query_rope=None, key_rope=None, pse_shift=None, atten_mask=None, actual_seq_qlen=[2], actual_seq_kvlen=[2], block_table=None, dequant_scale_query=None, dequant_scale_key=None, dequant_offset_key=None, dequant_scale_value=None, dequant_offset_value=None, dequant_scale_key_rope=None, quant_scale_out=None, quant_offset_out=None, quant_scale_p=None, learnable_sink=None, num_query_heads=1, num_key_value_heads=0, softmax_scale=1.0, pre_tokens=2147483647, next_tokens=2147483647, input_layout="BSH", sparse_mode=0, block_size=0, query_quant_mode=0, key_quant_mode=0, value_quant_mode=0, inner_precise=0, return_softmax_lse=False, query_dtype=0, key_dtype=0, value_dtype=0, query_rope_dtype=0, key_rope_dtype=0, key_shared_prefix_dtype=0, value_shared_prefix_dtype=0, dequant_scale_query_dtype=0, dequant_scale_key_dtype=0, dequant_scale_value_dtype=0, dequant_scale_key_rope_dtype=0, out_dtype=0)
        actual = npu_fused_infer_attention_score_v2(_ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), query_rope=None, key_rope=None, pse_shift=None, atten_mask=None, actual_seq_qlen=[2], actual_seq_kvlen=[2], block_table=None, dequant_scale_query=None, dequant_scale_key=None, dequant_offset_key=None, dequant_scale_value=None, dequant_offset_value=None, dequant_scale_key_rope=None, quant_scale_out=None, quant_offset_out=None, quant_scale_p=None, learnable_sink=None, num_query_heads=1, num_key_value_heads=0, softmax_scale=1.0, pre_tokens=2147483647, next_tokens=2147483647, input_layout="BSH", sparse_mode=0, block_size=0, query_quant_mode=0, key_quant_mode=0, value_quant_mode=0, inner_precise=0, return_softmax_lse=False, query_dtype=0, key_dtype=0, value_dtype=0, query_rope_dtype=0, key_rope_dtype=0, key_shared_prefix_dtype=0, value_shared_prefix_dtype=0, dequant_scale_query_dtype=0, dequant_scale_key_dtype=0, dequant_scale_value_dtype=0, dequant_scale_key_rope_dtype=0, out_dtype=0)
