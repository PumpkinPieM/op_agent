...
def _ops():
    ...
    if _CUSTOM_OPS is None:
        ...
        try:
            _CUSTOM_OPS = ms.ops.CustomOpBuilder("custom_ops__npu_fused_infer_attention_score_v2_get_max_workspace_test", [str(KERNEL_SOURCE)], backend="Ascend").load()
