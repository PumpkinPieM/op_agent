...
def _ops():
    ...
    if _CUSTOM_OPS is None:
        ...
        try:
            _CUSTOM_OPS = ms.ops.CustomOpBuilder("custom_ops_npu_grouped_matmul_swiglu_quant_v2_test", [str(KERNEL_SOURCE)], backend="Ascend").load()
...
def npu_grouped_matmul_swiglu_quant_v2(x, weight, weight_scale, x_scale, group_list, *, smooth_scale=None, weight_assist_matrix=None, bias=None, dequant_mode=0, dequant_dtype=0, quant_mode=0, quant_dtype=1, group_list_type=0, tuning_config=None, x_dtype=None, weight_dtype=None, weight_scale_dtype=None, x_scale_dtype=None):
    return _ops().npu_grouped_matmul_swiglu_quant_v2(x, weight, weight_scale, x_scale, group_list, smooth_scale, weight_assist_matrix, bias, dequant_mode, dequant_dtype, quant_mode, quant_dtype, group_list_type, tuning_config, x_dtype, weight_dtype, weight_scale_dtype, x_scale_dtype)


def test_npu_grouped_matmul_swiglu_quant_v2_matches_torch_npu():
    ...
    try:
        expected = torch_npu.npu_grouped_matmul_swiglu_quant_v2(_torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), smooth_scale=None, weight_assist_matrix=None, bias=None, dequant_mode=0, dequant_dtype=0, quant_mode=0, quant_dtype=1, group_list_type=0, tuning_config=[2], x_dtype=0, weight_dtype=0, weight_scale_dtype=0, x_scale_dtype=0)
        actual = npu_grouped_matmul_swiglu_quant_v2(_ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), smooth_scale=None, weight_assist_matrix=None, bias=None, dequant_mode=0, dequant_dtype=0, quant_mode=0, quant_dtype=1, group_list_type=0, tuning_config=[2], x_dtype=0, weight_dtype=0, weight_scale_dtype=0, x_scale_dtype=0)
