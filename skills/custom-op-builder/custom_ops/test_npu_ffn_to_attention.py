...
KERNEL_SOURCE = Path(__file__).with_name("npu_ffn_to_attention.cc")
_CUSTOM_OPS = None
...
def npu_ffn_to_attention(x, session_ids, micro_batch_ids, token_ids, expert_offsets, actual_token_num, group, world_size, token_info_table_shape, token_data_shape, *, attn_rank_table=None):
    return _ops().npu_ffn_to_attention(x, session_ids, micro_batch_ids, token_ids, expert_offsets, actual_token_num, group, world_size, token_info_table_shape, token_data_shape, attn_rank_table)
