...
std::vector<ms::Tensor> npu_qkv_rms_norm_rope_cache(const ms::Tensor & qkv, const ms::Tensor & q_gamma, const ms::Tensor & k_gamma, const ms::Tensor & cos, const ms::Tensor & sin, const ms::Tensor & index, const ms::Tensor & q_out, const ms::Tensor & k_cache, const ms::Tensor & v_cache, const std::vector<int64_t> & qkv_size, const std::vector<int64_t> & head_nums, const std::optional<ms::Tensor> & k_scale_opt, const std::optional<ms::Tensor> & v_scale_opt, const std::optional<ms::Tensor> & k_offset_opt, const std::optional<ms::Tensor> & v_offset_opt, double epsilon, const std::optional<std::string> & cache_mode_opt, bool is_output_qkv) {
...
PYBIND11_MODULE(MS_EXTENSION_NAME, m) {
  m.def("npu_qkv_rms_norm_rope_cache", PYBOOST_CALLER(3, custom::npu_qkv_rms_norm_rope_cache));
}
}  // namespace custom
