...
def npu_fusion_attention_v2(query, key, value, head_num, input_layout, *, pse=None, padding_mask=None,
                            atten_mask=None, query_rope=None, key_rope=None, scale=1., keep_prob=1.,
                            pre_tokens=2147483647, next_tokens=2147483647, inner_precise=0, prefix=None,
                            actual_seq_qlen=None, actual_seq_kvlen=None, sparse_mode=0, gen_mask_parallel=True,
                            sync=False, pse_type=1, q_start_idx=None, kv_start_idx=None, softmax_layout="",
                            sink=None, dropout_mask=None, seed=0, offset=0):
    outputs = _ops().npu_fusion_attention_v2(
        query, key, value, head_num, input_layout, pse, padding_mask, atten_mask, query_rope, key_rope, scale,
        keep_prob, pre_tokens, next_tokens, inner_precise, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode,
        gen_mask_parallel, sync, pse_type, q_start_idx, kv_start_idx, softmax_layout, sink, dropout_mask, seed, offset)
...
def test_npu_fusion_attention_v2_matches_torch_npu(shape, head_num, input_layout):
    ...
    expected = torch_npu.npu_fusion_attention_v2(
    ...
    actual = npu_fusion_attention_v2(
        ms_q, ms_k, ms_v, head_num, input_layout, pse=None, padding_mask=None, atten_mask=None,
        query_rope=None, key_rope=None, scale=1., keep_prob=1., pre_tokens=2147483647,
        next_tokens=2147483647, inner_precise=0, prefix=None, actual_seq_qlen=None, actual_seq_kvlen=None,
        sparse_mode=0, gen_mask_parallel=True, sync=False, pse_type=1, q_start_idx=None, kv_start_idx=None,
        softmax_layout="", sink=None, dropout_mask=None, seed=0, offset=0)
