...
ms::Tensor npu_quant_matmul_dequant(const ms::Tensor & x, const ms::Tensor & quantized_weight, const ms::Tensor & weight_scale, const std::optional<ms::Tensor> & bias_opt, const std::optional<ms::Tensor> & x_scale_opt, const std::optional<ms::Tensor> & x_offset_opt, const std::optional<ms::Tensor> & smooth_scale_opt, const std::optional<std::string> & quant_mode_opt) {
  ...
  runner->SetLaunchFunc(LAUNCH_ACLNN_FUNC(aclnnQuantMatmulDequant, x, quantized_weight, weight_scale, bias_opt, x_scale_opt, x_offset_opt, smooth_scale_opt, quant_mode, out));
