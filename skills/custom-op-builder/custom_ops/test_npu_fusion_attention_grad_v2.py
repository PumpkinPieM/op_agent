...
def _ops():
    ...
    if _CUSTOM_OPS is None:
        ...
        try:
            _CUSTOM_OPS = ms.ops.CustomOpBuilder("custom_ops_npu_fusion_attention_grad_v2_test", [str(KERNEL_SOURCE)], backend="Ascend").load()
...
def npu_fusion_attention_grad_v2(query, key, value, dy, head_num, input_layout, *, pse=None, padding_mask=None, atten_mask=None, softmax_max=None, softmax_sum=None, softmax_in=None, attention_in=None, query_rope=None, key_rope=None, scale_value=1., keep_prob=1., pre_tokens=2147483647, next_tokens=2147483647, inner_precise=0, seed=0, offset=0, numels=0, prefix=None, actual_seq_qlen=None, actual_seq_kvlen=None, sparse_mode=0, gen_mask_parallel=True, sync=False, pse_type=1, q_start_idx=None, kv_start_idx=None, softmax_layout="", sink=None):
    return _ops().npu_fusion_attention_grad_v2(query, key, value, dy, head_num, input_layout, pse, padding_mask, atten_mask, softmax_max, softmax_sum, softmax_in, attention_in, query_rope, key_rope, scale_value, keep_prob, pre_tokens, next_tokens, inner_precise, seed, offset, numels, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, pse_type, q_start_idx, kv_start_idx, softmax_layout, sink)


def test_npu_fusion_attention_grad_v2_matches_torch_npu():
    if not hasattr(torch_npu, "npu_fusion_attention_grad_v2"):
        pytest.skip("benchmark torch_npu API is unavailable on this host")
    try:
        expected = torch_npu.npu_fusion_attention_grad_v2(_torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), 0, "BSH", pse=None, padding_mask=None, atten_mask=None, softmax_max=None, softmax_sum=None, softmax_in=None, attention_in=None, query_rope=None, key_rope=None, scale_value=1., keep_prob=1., pre_tokens=2147483647, next_tokens=2147483647, inner_precise=0, seed=0, offset=0, numels=0, prefix=[2], actual_seq_qlen=[2], actual_seq_kvlen=[2], sparse_mode=0, gen_mask_parallel=True, sync=False, pse_type=1, q_start_idx=[2], kv_start_idx=[2], softmax_layout="", sink=None)
        actual = npu_fusion_attention_grad_v2(_ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), 0, "BSH", pse=None, padding_mask=None, atten_mask=None, softmax_max=None, softmax_sum=None, softmax_in=None, attention_in=None, query_rope=None, key_rope=None, scale_value=1., keep_prob=1., pre_tokens=2147483647, next_tokens=2147483647, inner_precise=0, seed=0, offset=0, numels=0, prefix=[2], actual_seq_qlen=[2], actual_seq_kvlen=[2], sparse_mode=0, gen_mask_parallel=True, sync=False, pse_type=1, q_start_idx=[2], kv_start_idx=[2], softmax_layout="", sink=None)
