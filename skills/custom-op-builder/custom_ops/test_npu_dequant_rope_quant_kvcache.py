...
def _ops():
    ...
    if _CUSTOM_OPS is None:
        ...
        try:
            _CUSTOM_OPS = ms.ops.CustomOpBuilder("custom_ops_npu_dequant_rope_quant_kvcache_test", [str(KERNEL_SOURCE)], backend="Ascend").load()
...
def npu_dequant_rope_quant_kvcache(x, cos, sin, k_cache, v_cache, indices, scale_k, scale_v, size_splits, *, offset_k=None, offset_v=None, weight_scale=None, activation_scale=None, bias=None, quant_mode=0, input_layout="BSND", kv_output=False, cache_mode="contiguous"):
    return _ops().npu_dequant_rope_quant_kvcache(x, cos, sin, k_cache, v_cache, indices, scale_k, scale_v, size_splits, offset_k, offset_v, weight_scale, activation_scale, bias, quant_mode, input_layout, kv_output, cache_mode)


def test_npu_dequant_rope_quant_kvcache_matches_torch_npu():
    if not hasattr(torch_npu, "npu_dequant_rope_quant_kvcache"):
        pytest.skip("benchmark torch_npu API is unavailable on this host")
    try:
        expected = torch_npu.npu_dequant_rope_quant_kvcache(_torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), _torch_f16((2, 2)), _torch_i32((2,)), _torch_f16((2, 2)), _torch_f16((2, 2)), [2], offset_k=None, offset_v=None, weight_scale=None, activation_scale=None, bias=None, quant_mode=0, input_layout="BSND", kv_output=False, cache_mode="contiguous")
        actual = npu_dequant_rope_quant_kvcache(_ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), _ms_f16((2, 2)), _ms_i32((2,)), _ms_f16((2, 2)), _ms_f16((2, 2)), [2], offset_k=None, offset_v=None, weight_scale=None, activation_scale=None, bias=None, quant_mode=0, input_layout="BSND", kv_output=False, cache_mode="contiguous")
